...
export default function Home() {
  ...
  <div className="w-full bg-[#1E1E1E] px-4 py-4 text-[13px] flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0 rounded-lg">
    <p className="text-center md:text-left">Email me at: peter@blockfuselabs.com</p>

    <div className="flex items-center gap-4 justify-center">
      <Link href="">
        {/* Facebook */}
        <svg width="7" height="14" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1.78669 14V7.43079H-0.000244141V5.06556H1.78669V3.04535C1.78669 1.45785 2.84225 0 5.27446 0C6.25923 0 6.98742 0.09177 6.98742 0.09177L6.93004 2.30049C6.93004 2.30049 6.1874 2.29347 5.377 2.29347C4.49991 2.29347 4.35939 2.68638 4.35939 3.33851V5.06556H6.99976L6.88487 7.43079H4.35939V14H1.78669Z" fill="white" />
        </svg>
      </Link>
      ...
      <Link href="">
        ...
        <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M17.9999 1.7049C17.3258 1.98937 16.6109 2.1761 15.8788 2.25887C16.6414 1.82346 17.2269 1.13398 17.5026 0.312468C16.7777 0.722276 15.9846 1.01101 15.1576 1.1662C14.4839 0.482477 13.5242 0.0551758 12.462 0.0551758C10.4225 0.0551758 8.76897 1.63041 8.76897 3.57326C8.76897 3.84904 8.80167 4.11752 8.8646 4.37508C5.79546 4.22831 3.07436 2.82771 1.25292 0.699175C0.935104 1.21878 0.752995 1.82319 0.752995 2.46786C0.752995 3.68848 1.405 4.76527 2.39585 5.39621C1.8094 5.37871 1.23587 5.22781 0.723112 4.95611C0.722901 4.97085 0.722901 4.98559 0.722901 5.00039C0.722901 6.70497 1.99584 8.12694 3.68517 8.45015C3.14136 8.59105 2.57095 8.61167 2.0175 8.51044C2.48739 9.90816 3.85125 10.9253 5.46717 10.9537C4.2033 11.8973 2.61093 12.4598 0.880823 12.4598C0.582698 12.4598 0.288792 12.4431 -0.00012207 12.4106C1.63415 13.4088 3.57527 13.9913 5.66074 13.9913C12.4534 13.9913 16.1678 8.63034 16.1678 3.98127C16.1678 3.82868 16.1643 3.67695 16.1571 3.5261C16.8801 3.02819 17.5041 2.41147 17.9999 1.7049Z" fill="white" />
        </svg>
      </Link>
