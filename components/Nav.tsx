...
const Nav = () => {
  ...
  const handleThemeToggle = () => {
    ...
    if (theme === "dark") {
      ...
      tl.to(moonIconRef.current, { y: -20, opacity: 0, scale: 0.8 }).fromTo(
        sunIconRef.current,
      ...
      tl.to(sunIconRef.current, { y: -20, opacity: 0, scale: 0.8 }).fromTo(
        moonIconRef.current,
        { y: 20, opacity: 0, scale: 0.8 },
        { y: 0, opacity: 1, scale: 1 },
        "-=0.2"
  ...
  return (
    <div className="fixed md:top-6 py-5 md:py-0 bg-black/40 backdrop-blur-sm md:bg-none left-0 right-0 z-40 px-4">
            ...
            >
              ...
              <nav className="flex flex-col gap-8 text-2xl text-white items-center w-full">
                <Link
                  href="/"
                  onClick={() => setMenuOpen(false)}
                  className="w-full text-center py-3 rounded-lg hover:bg-primary/20 transition"
                >
                  Home
                </Link>
                <a
